...
// ============================================
// GET - Listar todas las actividades o una específica
// ============================================
if ($method === 'GET') {
    try {
        // Si hay un ID, buscar una actividad específica
        if (isset($_GET['id'])) {
            $stmt = $pdo->prepare("
        ...
        // Si hay id_curso, filtrar por curso
        else if (isset($_GET['id_curso'])) {
            $stmt = $pdo->prepare("
                SELECT 
                    a.*,
